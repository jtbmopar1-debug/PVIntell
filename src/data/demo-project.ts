...
export const demoProject: Project = {
  ...
  installationSteps: [
    { id: "planning", title: "Planning & site preparation", description: "Confirm equipment locations, cable routes, ventilation, access, manuals and site-specific considerations.", safetyLevel: "user", expectedResult: "A documented layout ready for the next build stage.", complete: true },
    { id: "battery", title: "Battery installation", description: "Mount batteries as specified and verify isolation before interconnection.", safetyLevel: "high-current-dc", expectedResult: "A secure, isolated bank ready for connection checks.", complete: true },
    ...
    { id: "inverter", title: "Inverter installation", description: "Mount the inverter with required clearances and route segregated cabling.", safetyLevel: "licensed", expectedResult: "Equipment mounted and ready for connection checks.", complete: false },
    { id: "pv", title: "PV installation", description: "Install the array, earthing, DC cabling, labels and isolation shown in the recorded design.", safetyLevel: "licensed", expectedResult: "Array electrically isolated and ready for pre-power tests.", complete: false },
    { id: "ac", title: "AC wiring", description: "Complete and verify the planned AC connections and protection.", safetyLevel: "licensed", expectedResult: "Connection details and test results recorded.", complete: false },
    ...
    { id: "checks", title: "Pre-power checks", description: "Verify polarity, torque records, insulation tests, and protective devices.", safetyLevel: "licensed", expectedResult: "Completed pre-energisation checklist.", complete: false },
    { id: "commission", title: "Commissioning", description: "Energise in the manufacturer-defined sequence and record operating measurements.", safetyLevel: "licensed", expectedResult: "System operating normally with baseline readings.", complete: false },
  ],
  commissioning: [
