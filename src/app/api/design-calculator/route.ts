...
const calculatorSchema = z.object({
  ...
  design: z.object({
    ...
    panelWatts: finite.optional(), panelCount: finite.optional(), targetPvKw: finite.optional(), panelLengthMm: finite.optional(),
    panelWidthMm: finite.optional(), panelWeightKg: finite.optional(), requiredPanelAreaM2: finite.optional(),
...
export async function PUT(request: Request) {
  ...
  settings.designCalculator = { ...parsed.data.design, updatedAt: new Date().toISOString(), updatedBy: "user" };
