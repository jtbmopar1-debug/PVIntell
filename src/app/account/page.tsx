...
export default async function AccountPage({
  ...
  return (
    <main className="min-h-screen bg-canvas p-5 md:p-10">
      <div className="mx-auto max-w-2xl">
        ...
        <section className="card mt-6 p-6 md:p-8">
          <div className="flex gap-4">
            <span className="grid size-10 shrink-0 place-items-center rounded-xl bg-[#eaf2fb] text-brand">
              <ShieldCheck size={19} />
            </span>
            <div>
            ...
            <div className="flex-1">
              ...
              <form action={setPassword} className="mt-5 space-y-4">
                ...
                <PasswordField
                  ...
                  autoComplete="new-password"
                />
                <button className="h-11 w-full rounded-xl bg-brand text-xs font-bold text-white sm:w-auto sm:px-6">
                  Save password
                </button>
              </form>
            </div>
