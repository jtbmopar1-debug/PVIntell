...
export function siteDiscoveryActions(answers: DiscoveryAnswers): WattsonActionRequest[] {
  const values: Array<[string, string | number | string[] | undefined]> = [
    ...
    ["panel_construction_interest", answers.panel_construction_interest], ["existing_panel_selection", answers.existing_panel_selection], ["existing_power_equipment", answers.existing_power_equipment], ["panel_area_dimensions", answers.panel_area_dimensions],
    ...
    ["expected_expansion", answers.future_changes], ["ev_status", answers.ev_status], ["ev_vehicle_size", answers.ev_vehicle_size],
    ...
    ["ev_planning_power_band", answers.ev_planning_power_band],
