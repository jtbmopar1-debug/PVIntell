...
export function siteDiscoveryActions(answers: DiscoveryAnswers): WattsonActionRequest[] {
  const values: Array<[string, string | number | string[] | undefined]> = [
    ...
    ["pool_equipment_ratings", answers.pool_equipment_ratings], ["building_type", answers.building_type],
    ...
    ["panel_construction_interest", answers.panel_construction_interest], ["panel_area_dimensions", answers.panel_area_dimensions],
    ["panel_area_constraints", answers.panel_area_constraints], ["orientation_and_pitch", answers.orientation_and_pitch],
    ["shading", answers.shading], ["structure_condition", answers.structure_condition],
