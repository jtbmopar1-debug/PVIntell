...
const groups: FaqGroup[] = [
  { title: "Getting started", items: [
    ...
    { question: "Should I start Discovery or System Capture?", answer: "Start Discovery when you want guidance and a proposed design. Use System Capture when the system already exists and you can document its installed equipment and connections without inventing a past design journey." },
