  ...
  async function save(formData: FormData) {
    ...
    try {
      ...
      const response = await fetch("/api/systems/installed", {
        ...
        body: JSON.stringify({ idempotencyKey: idempotencyKeyRef.current, siteId, siteName: formData.get("siteName"), systemName: formData.get("systemName"), projectType: formData.get("projectType"), systemVoltage: voltage ? Number(voltage) : undefined }),
      });
